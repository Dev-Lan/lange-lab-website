...
Gehlenborg's [HIDIVE lab](https://hidivelab.org/).

I received my Computer Science PhD at the [University of Utah](https://www.utah.edu/)
in the [Scientific Computing and Imaging Institute](https://www.sci.utah.edu/),
where I worked in the [Visualization Design Lab](https://vdl.sci.utah.edu/)
advised by [Alexander Lex](https://vdl.sci.utah.edu/team/lex/).

My research interests span various data visualization challenges. I have worked
with single cell microscopy data to help researchers
[improve cancer treatment](https://loon.sci.utah.edu/), and have investigated how
visualizations can help
[review tabular datasets for falsification and fabrication](https://ferret.sci.utah.edu/).
